...
<html>
  <head>
    ...
    <link v-if='currentView.viewName === "instructions"' rel='stylesheet' href='assets/css/instructions.css'>
    <link v-if='currentView.viewName === "prices-selection"' rel='stylesheet' href='assets/css/prices.css'>
    <link v-if='currentView.viewName === "registration"' rel='stylesheet' href='assets/css/registration.css'>
  ...
  <body>
    ...
    <div id='congress' class='container'>
      ...
      <div class='content'>
        ...
        <transition name='component-fade' mode='out-in'>
          <component :is='currentView.viewName'
            :params='params' keep-alive></component>
        </transition>
    ...
    <script src='app/congress.conf.js'></script>
    <script src='app/bus.js'></script>
    ...
    <script src='app/congress.instance.js'></script>
